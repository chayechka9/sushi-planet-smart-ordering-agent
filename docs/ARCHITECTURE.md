...
This document records the intended system boundaries. The HTTP application, health route, order core and local order/payment persistence are implemented; external channel, payment-notification and Poster write paths are not active connections.
